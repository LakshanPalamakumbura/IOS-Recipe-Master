...
//
//THIS IS USE TO SIGN-IN CONTROL
...
//        signInButton.addTarget(self, action: #selector(signInButtonTapped), for: .touchUpInside)
        ...
        signUpButton.configuration?.imagePadding = 8.0 // for indicator spacing
...
//        print("Tapped")
        ...
        signvc.nav = self.navigationController
        signvc.view.backgroundColor = .systemBackground
